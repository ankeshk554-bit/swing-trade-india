...
<style>
    ...
    .main .block-container {{ background-color: {_bg} !important; padding: 1.5rem 2rem !important; max-width: 1400px !important; }}
    ...
    h1, h2, h3, h4, h5, h6 {{ color: {_text} !important; font-weight: 600 !important; letter-spacing: -0.02em !important; }}
    .stMarkdown, p, li {{ color: {_text} !important; font-size: 14px !important; }}
    .stCaption {{ color: {_text2} !important; font-size: 12px !important; }}
    ...
    .stSelectbox > div > div:focus, .stTextInput > div > div > input:focus {{ border-color: {_gold} !important; box-shadow: 0 0 0 1px {_gold}40 !important; }}
    ...
    div[data-testid="stSlider"] > div > div > div {{ background: {_gold} !important; }}
    [data-testid="StyledFullScreenButton"] {{ color: {_text} !important; }}
