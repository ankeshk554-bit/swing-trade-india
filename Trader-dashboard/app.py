...
<style>
    ...
    .stTextInput > div > div > input::placeholder, .stNumberInput > div > div > input::placeholder {{ color: {_text2} !important; }}
    .stTextInput label, .stNumberInput label, .stSelectbox label {{ color: {_text2} !important; font-size: 12px !important; }}
...
# =========================================================
    ...
    with st.expander("📡 Live V4 Universe Scanner — Find Stocks Ready NOW", expanded=False):
        ...
        with v4s_col1:
            v4s_uni = st.selectbox("Universe", ["Nifty 50", "Nifty 200", "Nifty 500", "Nifty 50 + Nifty 200"],
                                   index=0, key="v4s_uni")
        with v4s_col2:
